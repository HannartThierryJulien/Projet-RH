...
export class QuestionTestManageComponent implements OnInit, OnDestroy {
    ...
    forkJoin([
      ...this.addedQuestionsToRemove.map(q => {
        ...
        if (questionTestToRemove) {
          return this.questionTestAPIService.deleteItem(questionTestToRemove.id)
            .pipe(tap(() => {
      ...
      ...this.questionsToAdd.map(q => {
        ...
        return this.questionTestAPIService.addItem(questionTestToAdd)
