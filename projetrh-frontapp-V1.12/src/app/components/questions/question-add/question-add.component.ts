...
export class QuestionAddComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.questionForm = this.formBuilder.group({
      ...
      timeLimit: ['', [Validators.required, minimumTimeLimitValidator(30)]],
  ...
  onSubmit() {
    ...
    const newQuestion: Question = {
      ...
      timeLimit: '00:' + this.questionForm.value.timeLimit, // recover the 'mm:ss' as string and add 'hh' before to get format 'hh:mm:ss' for db
